...
const (
	AnalysisService_AnalyzeMetric_FullMethodName = "/proto.AnalysisService/AnalyzeMetric"
)
...
type AnalysisServiceClient interface {
	...
	AnalyzeMetric(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*AnalysisResponse, error)
}
...
func (c *analysisServiceClient) AnalyzeMetric(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*AnalysisResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnalysisResponse)
	err := c.cc.Invoke(ctx, AnalysisService_AnalyzeMetric_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AnalysisServiceServer interface {
	// Riceve una metrica, la analizza e decide cosa fare.
	AnalyzeMetric(context.Context, *Metric) (*AnalysisResponse, error)
...
func (UnimplementedAnalysisServiceServer) AnalyzeMetric(context.Context, *Metric) (*AnalysisResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AnalyzeMetric not implemented")
}
...
func _AnalysisService_AnalyzeMetric_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Metric)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalysisServiceServer).AnalyzeMetric(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AnalysisService_AnalyzeMetric_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServiceServer).AnalyzeMetric(ctx, req.(*Metric))
	}
...
var AnalysisService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AnalyzeMetric",
			Handler:    _AnalysisService_AnalyzeMetric_Handler,
		},
	},
